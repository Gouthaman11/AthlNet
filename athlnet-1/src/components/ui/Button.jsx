    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-manipulation",
    {
        variants: {
            variant: {
                ...
                danger: "bg-error text-error-foreground hover:bg-error/90 active:bg-error/95",
            },
            size: {
                default: "h-10 px-4 py-2 md:h-10 md:px-4 md:py-2",
                sm: "h-9 rounded-md px-3 md:h-9 md:px-3",
                lg: "h-12 rounded-md px-8 md:h-11 md:px-8",
                icon: "h-12 w-12 md:h-10 md:w-10",
                xs: "h-8 rounded-md px-2 text-xs md:h-8 md:px-2",
                xl: "h-14 rounded-md px-10 text-base md:h-12 md:px-10",
            },
        },
        defaultVariants: {
            variant: "default",
